package com.adityarastogi.lumiJournal.config;
...
public class SwaggerConfig {
    ...
    public OpenAPI myCustomConfig(){
        return new OpenAPI().info(
            new Info().title("LumiJournal API")
            .description("LumiJournal is a modern, secure, and efficient solution for journal management, tailored for users who demand high performance and real-time capabilities.")
        )
